...
import ir.maktab.java32.projects.articlesmanagement.features.articlemanagament.controllerimpl.userrole.CreateNewArticleUserControllerImpl;
...
public class CreateNewArticleUserView {
    ...
    public void create() {
        ...
        if (state) {
            CreateNewArticleUserController createNewArticleController = new CreateNewArticleUserControllerImpl();
